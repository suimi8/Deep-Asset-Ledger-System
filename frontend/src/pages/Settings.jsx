...
import { ShieldCheck, Save, Key, Globe, CheckCircle, XCircle, Loader2 } from 'lucide-react';
...
export default function Settings() {
    ...
    const handleSaveApiSettings = async () => {
        ...
        try {
            ...
            toast.success('System API Settings updated!');
            ...
            <div className="bg-gray-800/40 backdrop-blur-xl rounded-[2rem] border border-white/5 p-8 space-y-8 shadow-2xl">
                ...
                <div className="pt-8 border-t border-white/5">
                    <div className="flex items-center justify-between mb-6 px-1">
                        <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest">Global API Settings</h3>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                placeholder="Update Master API Key (leave empty to keep current)"
                        ...
                        <button
                            ...
                            disabled={saving}
                            className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white py-4 rounded-2xl font-bold transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20"
                        >
                    ...
                    <p className="mt-4 text-[11px] font-medium text-gray-500 px-1 leading-relaxed italic">
                        * Configure the custom API endpoint and master key for diagnosis and external integrations.
                    </p>
                </div>
